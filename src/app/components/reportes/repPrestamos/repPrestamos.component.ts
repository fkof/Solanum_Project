...
export class repPrestamos implements OnInit {
    ...
    ngOnInit() {
        ...
        this.prestamosService.getEstatusPrestamos().subscribe({
            next: data => {
                this.listEstatusPrestamo = data;
            }
        })
        this.getAllRoles();
    ...
    buscarsolicitudes() {
        ...
        let dataSend = {
            ...
            idEstatusPrestamo: this.estatusPrestamoSeleccionado
        }
    ...
    abrirCerrarMortizacion() {
        ...
        this.loading = true;
        if (this.selectSolicitud?.estatus == 'Autorizada') {
            this.prestamosService.getAmortizacion(this.selectSolicitud?.idSolicitud).subscribe({
                next: data => {
                    this.simulacionAmortizacion = [];
            ...
            this.prestamosService.getSimulacionAmortizacion({
